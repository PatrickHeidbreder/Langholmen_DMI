...
#SBATCH -o /scratch/project_2003480/patrick/data/gvfc/logs/allsites_vcf_%j_%a.out
#SBATCH -e /scratch/project_2003480/patrick/data/gvfc/logs/allsites_vcf_%j_%a.err
...
# can maybe use the depth outputs from the other SNP filtering?
mindp=492 # 2*246
maxdp=4920 # 20*246
